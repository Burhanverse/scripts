...
# Clone trees
git clone --depth 1 https://github.com/xiaomi-sm8250-devs/android_device_xiaomi_alioth -b lineage-21 device/xiaomi/alioth

git clone --depth 1 https://github.com/xiaomi-sm8250-devs/android_device_xiaomi_sm8250-common -b lineage-21 device/xiaomi/sm8250-common
